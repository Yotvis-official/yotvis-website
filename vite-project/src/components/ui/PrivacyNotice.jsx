...
export default function PrivacyNotice() {
  ...
  useEffect(() => {
    ...
    const consent = localStorage.getItem("yotvis-cookie-consent");
    if (!consent) {
  ...
  const handleAccept = () => {
    localStorage.setItem("yotvis-cookie-consent", "accepted");
    setIsVisible(false);
  };

  const handleDecline = () => {
    localStorage.setItem("yotvis-cookie-consent", "declined");
    setIsVisible(false);
  };
