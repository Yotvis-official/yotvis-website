  ...
  "relative grid gap-4 [&>*:first-child]:origin-top-right [&>*:nth-child(3)]:origin-bottom-right [&>*:nth-child(4)]:origin-top-right",
  {
    variants: {
      variant: {
        ...
        `,
        sixCells: `
          grid-cols-1 md:grid-cols-8 md:grid-rows-3
          [&>*:nth-child(1)]:md:col-span-5 [&>*:nth-child(1)]:md:row-span-1
          [&>*:nth-child(2)]:md:col-span-3 [&>*:nth-child(2)]:md:row-span-1
          [&>*:nth-child(3)]:md:col-span-4 [&>*:nth-child(3)]:md:row-span-1
          [&>*:nth-child(4)]:md:col-span-4 [&>*:nth-child(4)]:md:row-span-1
          [&>*:nth-child(5)]:md:col-span-3 [&>*:nth-child(5)]:md:row-span-1
          [&>*:nth-child(6)]:md:col-span-5 [&>*:nth-child(6)]:md:row-span-1
        `
      },
    },
    defaultVariants: {
